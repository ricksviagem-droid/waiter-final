...
export default function ThankYouPage() {
  ...
  return (
    <>
      <Header />
      <main className="min-h-screen bg-[#FDFAF4] flex items-center justify-center px-5 pt-16">
        <div className="w-full max-w-lg text-center flex flex-col items-center gap-6">

          {/* Icon */}
          <div className="w-20 h-20 rounded-full bg-[#1A4A6B] flex items-center justify-center shadow-xl">
          ...
          <div>
            <h1 className="font-[family-name:var(--font-fraunces)] text-3xl font-semibold text-[#1a1a1a] mb-2">
              {t('thankyou_title')}
            </h1>
            <p className="text-[#777] text-base font-[family-name:var(--font-dm-sans)] leading-relaxed">
              {t('thankyou_subtitle')}
            </p>
            <p className="text-[#999] text-sm font-[family-name:var(--font-dm-sans)] mt-2">
